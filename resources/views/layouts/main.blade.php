...
<html>
	...
	<body>
		...
		<script src="{{url('js/jquery.simpleLoadMore.min.js')}}"></script>
		<script>
			$('#cmtList').simpleLoadMore({
				item:'li',
				btnHTML:'<div style="text-align: center;"><a class="new-more" href="#">Xem Thêm</a></div>'
			});
		</script>
			    ...
			    var readURL = function(input) {
			        if (input.files && input.files[0]) {
			            ...
			            reader.onload = function (e) {
			                $('.acc-avatar').attr('src', e.target.result);
			            }
